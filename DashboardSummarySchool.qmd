...
---
title: "`r school.name` Dashboard DA Summary"
---
...
```
For `r school.name`, the below graph shows how at the school level their student groups did at the school level which contributed to `r dist.name` as an LEA overall.  Note this also includes student groups with 11 to 29 students in them to provide a fuller picture even if those groups are not used for state accountability calculations. 
