...
The graphic below shows the color for each student group for each indicator from the dashboard. This reflects the latest available colors from the [2022 dashboard](%60r%20paste0(%22https://www.caschooldashboard.org/reports/%22,dist,%22/2022%22)%60). Please note that this also includes student groups with 11-29 students for whom data is available but status is not used for accountability purposes.
...
This table displays which student groups qualified the district to be eligible for [Differentiated Assistance](https://www.cde.ca.gov/ta/ac/cm/leaproposedcrit.asp). Moreover, for each student group it shows which Priority Areas and associated indicator criteria for which the student group qualifies.
